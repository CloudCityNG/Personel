...
define('UU_USER_ADD_UPDATE', 1);
define('UU_USER_UPDATE', 2);
...
class uu_progress_tracker {
    ...
    private $_row;
    public $columns = array('status', 'line', 'firstname', 'middlename', 'lastname', 'gender', 'city', 'dob', 'country', 'phone1', 'email', 'schoolname', 'address');
