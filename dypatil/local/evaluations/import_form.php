...
class evaluation_import_form extends moodleform {
    ...
    public function definition() {
        ...
        $strdeleteolditmes = get_string('delete_old_items', 'local_evaluations') .
                ' (' . get_string('oldvalueswillbedeleted', 'local_evaluations') . ')';

        $strnodeleteolditmes = get_string('append_new_items', 'local_evaluations') .
                ' (' . get_string('oldvaluespreserved', 'local_evaluations') . ')';
