...
$(document).ready(function() {
    ...
    var tableContainer = $('#studentstatustable');
    $("#studentstatustable tr th").each(function() {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#studentstatustable thead tr> :nth-child(1)").each(function() {
        $(this)
