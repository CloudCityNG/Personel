...
$(document).ready(function() {
    ...
    var tableContainer = $('#taxratetable');
    $("#taxratetable tr th").each(function() {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#taxratetable thead tr> :nth-child(1)").each(function() {
        $(this)
  ...
  oTable.coFilter({
    	           ...
    	           aoColumns: [ 1,2,0 ],
                   columntitles:{0: "Tax Name", 1: "Tax Type", 2: "Country"},
	           filtertype: {0: "text", 1: "select", 2: "select"}
  });
});
