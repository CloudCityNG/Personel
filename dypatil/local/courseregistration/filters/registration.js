...
$(document).ready(function () {
    ...
    var tableContainer = $('#classregistration');
    $("#classregistration tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#classregistration thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [1, 2, 5, 0],
        columntitles: {0: "Student Name", 1: "Class Code", 2: "Course Name", 5: "Course Status"},
