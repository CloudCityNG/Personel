...
$PAGE->set_url('/local/timetable/scheduleclassview.php');
//Header and the navigation bar
$PAGE->set_heading($SITE->fullname);
$PAGE->navbar->add(get_string('pluginname', 'local_timetable'), new moodle_url('/local/timetable/scheduleclassview.php'));
$PAGE->navbar->add(get_string('scheduleclass_timetable', 'local_timetable'));


//this is the return url 
$returnurl = new moodle_url('/local/timetable/scheduleclassview.php', array('id' => $id));
...
$tmobject = new timetable($schoolid, "scheduled");
