...
/**
 * Bulk department registration functions
 *
 * @package    local
...
define('UU_DEPARTMENT_ADDNEW', 0);
define('UU_DEPARTMENT_ADD_UPDATE', 1);
define('UU_DEPARTMENT_UPDATE', 2);
...
/**
 * Tracking of processed departments.
 *
 * This class prints department information into a html table.
 *
 * @package    core
 * @subpackage admin
 ...
 * @param array $stdfields standard department fields
 * @param array $profilefields custom profile fields
 * @param moodle_url $returnurl return url in case of any error
 * @return array list of fields
 */
function uu_validate_department_upload_columns(csv_import_reader $cir, $stdfields, $profilefields, moodle_url $returnurl) {
    ...
    foreach ($columns as $key => $unused) {
        ...
        if (in_array($field, $stdfields) or in_array($lcfield, $stdfields)) {
            ...
            $newfield = $lcfield;
        } else if (preg_match('/^(cohort|department|group|type|role|enrolperiod)\d+$/', $lcfield)) {
