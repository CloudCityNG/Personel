...
/**
 * Bulk program registration functions
 *
 * @package    local
...
define('UU_PROGRAM_ADDNEW', 0);
define('UU_PROGRAM_ADDINC', 1);
define('UU_PROGRAM_ADD_UPDATE', 2);
define('UU_PROGRAM_UPDATE', 3);
...
/**
 * Tracking of processed programs.
 *
 * This class prints program information into a html table.
 *
 * @package    core
 * @subpackage admin
...
class uu_progress_tracker {
    ...
    private $_row;
    public $columns = array('status', 'line', 'fullname', 'shortname', 'departmentname', 'schoolname', 'type', 'programlevel', 'description', 'visible', 'duration');
 ...
 * @param array $stdfields standard program fields
 * @param array $profilefields custom profile fields
 * @param moodle_url $returnurl return url in case of any error
 * @return array list of fields
 */
function uu_validate_program_upload_columns(csv_import_reader $cir, $stdfields, $profilefields, moodle_url $returnurl) {
    ...
    foreach ($columns as $key => $unused) {
        ...
        if (in_array($field, $stdfields) or in_array($lcfield, $stdfields)) {
            ...
            $newfield = $lcfield;
        } else if (preg_match('/^(cohort|program|group|type|role|enrolperiod)\d+$/', $lcfield)) {
