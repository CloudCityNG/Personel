...
/**
 * Bulk school registration functions
 *
 * @package    local
...
define('UU_SCHOOL_ADDNEW', 0);
define('UU_SCHOOL_ADDINC', 1);
define('UU_SCHOOL_ADD_UPDATE', 2);
define('UU_SCHOOL_UPDATE', 3);
...
/**
 * Tracking of processed schools.
 *
 * This class prints school information into a html table.
 *
 * @package    core
 * @subpackage admin
...
class uu_progress_tracker {
    ...
    private $_row;
    public $columns = array('status', 'line', 'fullname', 'parentid', 'type', 'visible', 'description', 'childpermissions');
 ...
 * @param array $stdfields standard school fields
 * @param array $profilefields custom profile fields
 * @param moodle_url $returnurl return url in case of any error
 * @return array list of fields
 */
function uu_validate_school_upload_columns(csv_import_reader $cir, $stdfields, $profilefields, moodle_url $returnurl) {
    ...
    foreach ($columns as $key => $unused) {
        ...
        if (in_array($field, $stdfields) or in_array($lcfield, $stdfields)) {
            ...
            $newfield = $lcfield;
        } else if (preg_match('/^(cohort|school|group|type|role|enrolperiod)\d+$/', $lcfield)) {
