...
$(document).ready(function () {
    ...
    var tableContainer = $('#curriculumtable');
    $("#curriculumtable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#curriculumtable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [1, 2],
        columntitles: {1: "Program", 2: "Organization"},
