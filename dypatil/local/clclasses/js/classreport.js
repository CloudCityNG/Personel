...
$(document).ready(function() {
    ...
    var tableContainer = $('#classreport');
    $("#classreport tr th").each(function() {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#classreport thead tr> :nth-child(1)").each(function() {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [2, 3],
        columntitles: {2: "Class Name", 3: "Course Offering"},
        filtertype: {0: "text", 3: "select"},
        dateformat: "D ,M d,yy"
    });
});