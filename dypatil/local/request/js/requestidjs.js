...
$(document).ready(function () {
    ...
    var tableContainer = $('#requestidtable');
    $("#requestidtable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#requestidtable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [0, 1],
        columntitles: {0: "Program", 1: "Course Offering"},
