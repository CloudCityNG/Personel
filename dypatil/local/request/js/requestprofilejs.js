...
$(document).ready(function () {
    ...
    var tableContainer = $('#requestprofiletable');
    $("#requestprofiletable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#requestprofiletable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [1, 2],
        columntitles: {1: "Organization", 2: "Program"},
