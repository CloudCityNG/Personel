...
$(document).ready(function () {
    ...
    $("#class tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#class thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [0, 2, 3, 4],
        columntitles: {0: "Classroom", 2: "Floor", 3: "Building", 4: "Organization"},
        filtertype: {0: "select", 2: "select", 3: "select", 4: "select"},
        dateformat: "D ,M d,yy"
    });
});