...
function theme_clean_page_init(moodle_page $page) {
    ...
    $page->requires->jquery_plugin('modernizr', 'theme_clean');
    //$page->requires->jquery_plugin('cslider', 'theme_clean');
    //$page->requires->jquery_plugin('custom', 'theme_clean');
}

function clean_get_latest_events() {
    global $CFG, $DB;
