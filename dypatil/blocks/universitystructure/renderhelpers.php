...
class block_universitystructure_menu {
	...
	public function universitystructure_get_class_if_active ($myid, $mytype, $alist=null,$mydepth=null) {
		...
		elseif ($myid== 'school' && ($PAGE->pagetype == 'site-index' || $PAGE->pagetype =='admin-index')) {
	 ...
	 public function timetable_menu(){
	  ...
	  public function student_menu(){
		...
		if(isloggedin()){
		 ...
		 $myclass = $this->universitystructure_get_class_if_active('myacademics', 'u_leaf');
		 ...
		 $myclass = $this->universitystructure_get_class_if_active('courseregistration', 'mycur.php');
                 $items[]=$this->universitystructure_collect_items($myclass,'null',get_string('pluginname','local_curriculum'),3,'module',$CFG->wwwroot.'/local/courseregistration/mycur.php', null, 1);
