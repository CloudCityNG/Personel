...
//Make Active curriculum plan for DYPatil
$string['selectbatch'] = 'Select Batch';
$string['selectplan'] = 'Select Semester';
$string['selectsemester'] = 'Select Semester Offering';
$string['selectplan_help'] = 'Select the semester to make active for above offering to the batch';
$string['makeactive'] = 'Make Active';
$string['activeplandes'] = 'Make a semester active for the current or upcoming semester offering for a batch.';
$string['activeplan'] = 'Active Semester';
$string['batch'] = 'Batch';
$string['curri_plan'] = 'Semester';
$string['semester'] = 'Offering In';
$string['program'] = 'Program';
$string['school'] = 'School';
$string['makeactiveplan'] = 'Make Active Semester for Batch';
$string['viewactiveplan'] = 'View Active Semester for Batches';
//$string['seminfo'] = '<span style="color: #009C2F">For this batch, Semester is made active in this semester offering. Selection of another semester will be updated.</span>';
$string['semmadeactive'] = 'For this batch, A Semester made active in this semeter offering. Please choose another batch / another semester offering.';
$string['removeactiveplan'] = 'Remove active semester for Batch';
$string['removeactiveplan_confirm'] = 'Are you sure? you want to remove this as active for the batch!';
$string['norecordsfound'] = 'No Records Found';
$string['planactiveforotheroffering'] = 'This semester is active for another semester offering for this batch';
$string['curriculum'] = 'Curriculum';
$string['curriculum'] = 'Curriculum';