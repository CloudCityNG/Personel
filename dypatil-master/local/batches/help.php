...
echo get_string('batcheshelp_table1', 'local_batches');
$select = new single_select(new moodle_url('#'), 'proid', $countries, null, '');
$select->set_label('');
echo $OUTPUT->render($select);
echo get_string('batcheshelp_table2', 'local_batches');
//$select = new single_select(new moodle_url('#'), 'proid', $countries, null, '');
//$select->set_label('');
//echo $OUTPUT->render($select);
//echo get_string('batcheshelp_table3', 'local_batches');
//$select = new single_select(new moodle_url('#'), 'proid', $countries, null, '');
//$select->set_label('');
//echo $OUTPUT->render($select);
//echo get_string('batcheshelp_table4', 'local_batches');
echo $OUTPUT->footer();
?>
