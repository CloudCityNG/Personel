...
/**
 * Bulk exam registration functions
 *
 * @package    local
...
define('UU_EXAM_ADDNEW', 0);
define('UU_EXAM_ADD_UPDATE', 1);
define('UU_EXAM_UPDATE', 2);
...
/**
 * Tracking of processed exams.
 *
 * This class prints exam information into a html table.
 *
 * @package    core
 * @subpackage admin
 ...
 * @param array $stdfields standard exam fields
 * @param array $profilefields custom profile fields
 * @param moodle_url $returnurl return url in case of any error
 * @return array list of fields
 */
function uu_validate_exam_upload_columns(csv_import_reader $cir, $stdfields, $profilefields, moodle_url $returnurl) {
    ...
    foreach ($columns as $key => $unused) {
        ...
        if (in_array($field, $stdfields) or in_array($lcfield, $stdfields)) {
            ...
            $newfield = $lcfield;
        } else if (preg_match('/^(cohort|exam|group|type|role|enrolperiod)\d+$/', $lcfield)) {
