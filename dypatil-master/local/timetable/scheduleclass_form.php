    ...
    public function validation($data, $files) {
        ...
        foreach ($classtypes as $cltype) {
            ...
            if (isset($data[$clname]['othertimeinterval'])) {
                ...
                //$sql= "select * from mdl_local_timeintervals where schoolid=$schoolid and semesterid=$semesterid
                //                and '$tempstarttime' = starttime and '$tempendtime' = endtime";

                $sql = "select * from mdl_local_timeintervals where schoolid=$schoolid 
                                and '$tempstarttime' = starttime and '$tempendtime' = endtime";
                ...
                //----------------checking selected time is lies between   exists timeintervals----------------------
                $sql = "select * from mdl_local_timeintervals where schoolid=$schoolid 
                        and (   starttime < '$tempstarttime' and  '$tempstarttime'< endtime) or ('$tempstarttime'< endtime  and endtime < '$tempendtime' )";
