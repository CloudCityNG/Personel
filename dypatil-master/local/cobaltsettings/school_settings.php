...
try {
    ...
    if ($form_data) {
        /* jan 29 */
        $temp_set = array('batch', 'prefix_suffix', 'onlineapp', 'certificate', 'onlinepayment');
        /* jan 29 */
        $temp = new stdClass();
    ...
    foreach ($registrar_asigned_school as $r_s) {
        ...
        foreach ($exists_set as $exists) {
            ...
            /* Jan 29 */
            if ($exists->name == 'onlinepayment')
                $opcheck = ($exists->value == 1) ? 'checked' : '';
            /* Jan 29 */
        }
        ...
        /* Jan 29 */
        $line[] = '<input type="checkbox" name="onlinepayment" ' . $opcheck . ' value="1" >';
        /* Jan 29 */
    ...
    $table->head = array(
        ...
        /* Jan 29 */
        get_string('pluginname', 'local_onlinepayment') /* Jan 29 */);
