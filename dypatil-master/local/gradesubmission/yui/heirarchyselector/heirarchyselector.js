YUI.add('moodle-local_gradesubmission-heirarchyselector', function (Y) {
    ...
    M.local_gradesubmission = M.local_gradesubmission || {}; // This line use existing name path if it exists, ortherwise create a new one. 
    // This is to avoid to overwrite previously loaded module with same name.
    M.local_gradesubmission.init_heirarchyselector = function (config) { // 'config' contains the parameter values
