...
$strheading = get_string('stuview', 'local_gradesubmission');
...
if (!empty($data)) {
    $PAGE->requires->js('/local/gradesubmission/stugrades.js');
...
$table->id = 'gradesview';
$table->head = array(
    get_string('programname', 'local_gradesubmission'),
    get_string('semestername', 'local_gradesubmission'),
    get_string('classname', 'local_gradesubmission'),
    get_string('coursename', 'local_gradesubmission'),
