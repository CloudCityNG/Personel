YUI.add('moodle-local_evaluations-dragdrop', function(Y) {
    var DRAGDROPNAME = 'local_evaluations_dragdrop';
    var CSS = {
        OLDMOVE : 'span.evaluation_item_command_move',
        OLDMOVEUP : 'span.evaluation_item_command_moveup',
        OLDMOVEDOWN : 'span.evaluation_item_command_movedown',
        DRAGAREA : '#evaluation_dragarea',
        DRAGITEM : 'li.evaluation_itemlist',
        DRAGLIST : '#evaluation_dragarea ul#evaluation_draglist',
        POSITIONLABEL : '.evaluation_item_commands.position',
        ITEMBOX : '#evaluation_item_box_',
    ...
    Y.extend(DRAGDROP, M.core.dragdrop, {
        ...
        initializer : function(params) {
            ...
            handletitle = M.util.get_string('move_item', 'local_evaluations');
            ...
            listitems = basenode.all(CSS.DRAGITEM).each(function(v) {
                item_id = this.get_node_id(v.get('id')); //Get the id of the evaluation item.
        ...
        save_item_order : function(cmid, itemorder, spinner) {
            ...
            Y.io(M.cfg.wwwroot + '/local/evaluations/ajax.php', {
    ...
    M.local_evaluations = M.local_evaluations || {};
    M.local_evaluations.init_dragdrop = function(params) {
