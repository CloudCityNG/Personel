...
define('UU_COURSE_ADDNEW', 0);

define('UU_COURSE_ADD_UPDATE', 1);
define('UU_COURSE_UPDATE', 2);
...
class uu_progress_tracker {
    ...
    private $_row;
    public $columns = array('status', 'line', 'id', 'fullname', 'shortname', 'departmentname', 'schoolname',
        'summary', 'coursetype', 'credithours', 'coursecost', 'visible');
