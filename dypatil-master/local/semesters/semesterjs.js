...
$(document).ready(function () {
    ...
    var tableContainer = $('#semestertable');
    $("#semestertable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#semestertable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [0, 1, 2],
        columntitles: {0: "Course Offering", 1: "Organization", 2: "Start Date"},
        filtertype: {0: "text", 1: "select", 2: "date"},
        dateformat: "d-M-yy"
    });
});