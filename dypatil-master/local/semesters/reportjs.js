...
$(document).ready(function () {
    ...
    var tableContainer = $('#semesterreporttable');
    $("#semesterreporttable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#semesterreporttable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [0],
        columntitles: {0: "Course Offering"},
        filtertype: {0: "text"}
    });
});