...
$(document).ready(function () {
    ...
    var tableContainer = $('#approvalidtable');
    $("#approvalidtable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#approvalidtable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [2, 3, 6],
        columntitles: {2: "Organization", 3: "Program", 6: "Status"},
        filtertype: {2: "select", 3: "select", 6: "select"}
