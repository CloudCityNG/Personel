...
$(document).ready(function () {
    ...
    var tableContainer = $('#requesttranscripttable');
    $("#requesttranscripttable tr th").each(function () {
        $(this)
                .attr("data-hide", "phone,tablet")
    });
    $("#requesttranscripttable thead tr> :nth-child(1)").each(function () {
        $(this)
    ...
    oTable.coFilter({
        ...
        aoColumns: [0, 2],
        columntitles: {0: "Course Offering", 2: "Status"},
