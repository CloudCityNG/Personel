...
$THEME->sheets[] = 'custom';
$THEME->sheets[] = 'datatables.responsive';
...
$frontmiddle = array('front-middle');
...
$THEME->layouts = array(
    ...
    'frontpage' => array(
        'file' => 'frontpage.php',
        'regions' => array_merge(array('side-pre', 'footer-left', 'footer-middle', 'footer-right', 'hidden-dock'), $addregions, $frontmiddle),
    ...
    'mydashboard' => array(
        'file' => 'dashboard.php',
        'regions' => array_merge(array('side-pre', 'footer-left', 'footer-middle', 'footer-right'), $addregions, $frontmiddle),
        'defaultregion' => 'side-pre',
    ),
    // My public page.
    'mypublic' => array(
...
$THEME->javascripts = array('jquery.dataTables.min', 'moment.min',
    'fullcalendar.min',
    'jquery-ui1');
