...
/* Core */
$string['configtitle'] = 'CoLMS';
$string['pluginname'] = 'CoLMS';
$string['loggedinas'] = '{$a}';
...
<div class="well">
<h3>About CoLMS</h3>
<p>CoLMS is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
$string['bllogo'] = 'Before Login Logo';
$string['bllogodesc'] = 'Please upload your custom logo here if you want to add it to the header before login.<br>If you upload a logo it will replace the standard icon and name that was displayed by default.';
$string['allogo'] = 'After Login Logo';
$string['allogodesc'] = 'Please upload your custom logo here if you want to add it to the header after login.<br>If you upload a logo it will replace the standard icon and name that was displayed by default.';
...
$string['region-footer-second'] = 'Footer (Second)';
$string['region-footer-middle'] = 'Footer (Middle)';
$string['region-footer-third'] = 'Footer (Right)';
$string['region-footer-fourth'] = 'Footer (Fourth)';
$string['region-hidden-dock'] = 'Hidden from users';
$string['region-dashboard-one'] = 'Dashboard (One)';
$string['region-dashboard-two'] = 'Dashboard (Two)';
$string['region-dashboard-three'] = 'Dashboard (three)';
$string['region-dashboard-four'] = 'Dashboard (Four)';
...
$string['marketing1link'] = 'Link For Marketing One';
$string['marketing1linkdesc'] = 'Link for marketing one spot  (i.e http://www.example.com/mycollege)';
$string['marketing2link'] = 'Link For Marketing Two';
$string['marketing2linkdesc'] = 'Link for marketing two spot  (i.e http://www.example.com/mycollege)';
$string['marketing3link'] = 'Link For Marketing Three';
$string['marketing3linkdesc'] = 'Link for marketing three spot  (i.e http://www.example.com/mycollege)';
$string['marketing4link'] = 'Link For Marketing Four';
$string['marketing4linkdesc'] = 'Link for marketing four spot  (i.e http://www.example.com/mycollege)';
...
$string['marketing4'] = 'Marketing Spot Four - Title';
$string['marketing4desc'] = 'Title to show in this marketing spot';
$string['marketing4content'] = 'Marketing Spot Four - Content';
$string['marketing4contentdesc'] = 'Content to display in the marketing box. Keep it short and sweet.';
...
$string['video'] = "Frontpage video";
$string['videodesc'] = "Description";

$string['charts'] = "Charts";
$string['chartsdesc'] = "Front page charts";

$string['numberofdashboards'] = "Number of dashboards";
$string['numberofdashboardsdesc'] = "Number of dashboard Placeholders";

$string['dashboardsettings'] = 'Dashboard Layout Settings';
$string['selectdashboard'] = 'Dashboard Layout';
$string['changessaved'] = 'Dashboard layout changes updated successfully';